...
It doesn't include all syntaxs here, if you'd like to know more, you can check <a herf="https://codewithmosh.com/">Code with Mosh</a>, which I've learning from.<br/>
